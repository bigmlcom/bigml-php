...
# under the License.
	...
	function read_votes($votes_files, $model, $data_locale=null)
    {
            /*
                ...
                that casts the string prediction values read from the file to their real type. For instance
                ...
                data_locale should contain the string identification for the locale used in numeric formatting. 
            */
            ...
            foreach (range(0, (count($votes_files)-1)) as $order) {
                ...
                while ( ($row = fgetcsv($handle) ) !== FALSE ) {
                    ...
                    array_push($votes[$index]->predictions, array("prediction" => $prediction,
