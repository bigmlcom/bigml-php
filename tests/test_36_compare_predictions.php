...
class BigMLTestDeepnets extends PHPUnit_Framework_TestCase
{
    ...
    public function test_scenario1() {
        ...
        foreach($data as $item) {
            ...
            $resource = self::$api->_check_resource($deepnet->resource, null, 3000, 50);
            $this->assertEquals(BigMLRequest::FINISHED, $resource["status"]);
            ...
            print_r($prediction->object->prediction->$item["objective"]);
            ...
            print_r($local_prediction["prediction"]);
            $this->assertEquals($prediction->object->prediction->$item["objective"], 
